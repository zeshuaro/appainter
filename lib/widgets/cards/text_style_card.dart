      ...
      children: [
        SideBySideList(
          children: [
            ...
            DropdownListTile(
              title: 'Font Style',
              value: MyFontStyle().stringFromEnum(fontStyle),
              values: MyFontStyle().names,
        ...
        SideBySideList(
          children: [
            ...
            DropdownListTile(
              ...
              value: MyTextDecorationStyle().stringFromEnum(decorationStyle),
              values: MyTextDecorationStyle().names,
