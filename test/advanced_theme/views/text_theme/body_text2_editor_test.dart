...
void main() {
  final widgetTesters = WidgetTesters(expandText: 'Body Text 2');
  ...
  Future<void> _pumpApp(WidgetTester tester, AdvancedThemeState state) async {
    ...
    await tester.pumpApp(const BodyText2Editor(), advancedThemeCubit: cubit);
  }

  testWidgets('should display BodyText2Editor', (tester) async {
    await tester.pumpApp(const BodyText2Editor(), advancedThemeCubit: cubit);
    expect(find.byType(BodyText2Editor), findsOneWidget);
  });
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final state = AdvancedThemeState(
        themeData: ThemeData(
          textTheme: TextTheme(
            bodyText2: TextStyle(fontSize: value),
          ),
        ),
      );
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final state = AdvancedThemeState(
        themeData: ThemeData(
          textTheme: TextTheme(
            bodyText2: TextStyle(letterSpacing: value),
          ),
        ),
      );
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final state = AdvancedThemeState(
        themeData: ThemeData(
          textTheme: TextTheme(
            bodyText2: TextStyle(wordSpacing: value),
          ),
        ),
      );
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final state = AdvancedThemeState(
        themeData: ThemeData(
          textTheme: TextTheme(
            bodyText2: TextStyle(height: value),
          ),
        ),
      );
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final state = AdvancedThemeState(
        themeData: ThemeData(
          textTheme: TextTheme(
            bodyText2: TextStyle(decorationThickness: value),
          ),
        ),
      );
