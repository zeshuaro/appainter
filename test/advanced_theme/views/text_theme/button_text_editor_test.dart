...
void main() {
  final widgetTesters = WidgetTesters(expandText: 'Button Text');
  ...
  Future<void> _pumpApp(WidgetTester tester, AdvancedThemeState state) async {
    ...
    await tester.pumpApp(const ButtonTextEditor(), advancedThemeCubit: cubit);
  }

  testWidgets('should display ButtonTextEditor', (tester) async {
    await tester.pumpApp(const ButtonTextEditor(), advancedThemeCubit: cubit);
    expect(find.byType(ButtonTextEditor), findsOneWidget);
  });
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final state = AdvancedThemeState(
        themeData: ThemeData(
          textTheme: TextTheme(
            button: TextStyle(letterSpacing: value),
          ),
        ),
      );
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final state = AdvancedThemeState(
        themeData: ThemeData(
          textTheme: TextTheme(
            button: TextStyle(wordSpacing: value),
          ),
        ),
      );
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final state = AdvancedThemeState(
        themeData: ThemeData(
          textTheme: TextTheme(
            button: TextStyle(decorationThickness: value),
          ),
        ),
      );
