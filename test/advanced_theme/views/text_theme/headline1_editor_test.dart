...
void main() {
  final widgetTesters = WidgetTesters(expandText: 'Headline 1');
  ...
  Future<void> _pumpApp(WidgetTester tester, AdvancedThemeState state) async {
    ...
    await tester.pumpApp(const Headline1Editor(), advancedThemeCubit: cubit);
  }

  testWidgets('should display Headline1Editor', (tester) async {
    await tester.pumpApp(const Headline1Editor(), advancedThemeCubit: cubit);
    expect(find.byType(Headline1Editor), findsOneWidget);
  });
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final state = AdvancedThemeState(
        themeData: ThemeData(
          textTheme: TextTheme(
            headline1: TextStyle(fontSize: value),
          ),
        ),
      );
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final state = AdvancedThemeState(
        themeData: ThemeData(
          textTheme: TextTheme(
            headline1: TextStyle(letterSpacing: value),
          ),
        ),
      );
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final state = AdvancedThemeState(
        themeData: ThemeData(
          textTheme: TextTheme(
            headline1: TextStyle(wordSpacing: value),
          ),
        ),
      );
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final state = AdvancedThemeState(
        themeData: ThemeData(
          textTheme: TextTheme(
            headline1: TextStyle(height: value),
          ),
        ),
      );
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final state = AdvancedThemeState(
        themeData: ThemeData(
          textTheme: TextTheme(
            headline1: TextStyle(decorationThickness: value),
          ),
        ),
      );
