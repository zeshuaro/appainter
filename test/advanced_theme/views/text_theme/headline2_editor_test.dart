...
void main() {
  final widgetTesters = WidgetTesters(expandText: 'Headline 2');
  ...
  Future<void> _pumpApp(WidgetTester tester, AdvancedThemeState state) async {
    ...
    await tester.pumpApp(const Headline2Editor(), advancedThemeCubit: cubit);
  }

  testWidgets('should display Headline2Editor', (tester) async {
    await tester.pumpApp(const Headline2Editor(), advancedThemeCubit: cubit);
    expect(find.byType(Headline2Editor), findsOneWidget);
  });
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final state = AdvancedThemeState(
        themeData: ThemeData(
          textTheme: TextTheme(
            headline2: TextStyle(fontSize: value),
          ),
        ),
      );
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final state = AdvancedThemeState(
        themeData: ThemeData(
          textTheme: TextTheme(
            headline2: TextStyle(letterSpacing: value),
          ),
        ),
      );
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final state = AdvancedThemeState(
        themeData: ThemeData(
          textTheme: TextTheme(
            headline2: TextStyle(wordSpacing: value),
          ),
        ),
      );
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final state = AdvancedThemeState(
        themeData: ThemeData(
          textTheme: TextTheme(
            headline2: TextStyle(height: value),
          ),
        ),
      );
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final state = AdvancedThemeState(
        themeData: ThemeData(
          textTheme: TextTheme(
            headline2: TextStyle(decorationThickness: value),
          ),
        ),
      );
