...
void main() {
  final widgetTesters = WidgetTesters(expandText: 'Headline 6');
  ...
  Future<void> _pumpApp(WidgetTester tester, AdvancedThemeState state) async {
    ...
    await tester.pumpApp(const Headline6Editor(), advancedThemeCubit: cubit);
  }

  testWidgets('should display Headline6Editor', (tester) async {
    await tester.pumpApp(const Headline6Editor(), advancedThemeCubit: cubit);
    expect(find.byType(Headline6Editor), findsOneWidget);
  });
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final state = AdvancedThemeState(
        themeData: ThemeData(
          textTheme: TextTheme(
            headline6: TextStyle(fontSize: value),
          ),
        ),
      );
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final state = AdvancedThemeState(
        themeData: ThemeData(
          textTheme: TextTheme(
            headline6: TextStyle(letterSpacing: value),
          ),
        ),
      );
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final state = AdvancedThemeState(
        themeData: ThemeData(
          textTheme: TextTheme(
            headline6: TextStyle(wordSpacing: value),
          ),
        ),
      );
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final state = AdvancedThemeState(
        themeData: ThemeData(
          textTheme: TextTheme(
            headline6: TextStyle(height: value),
          ),
        ),
      );
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final state = AdvancedThemeState(
        themeData: ThemeData(
          textTheme: TextTheme(
            headline6: TextStyle(decorationThickness: value),
          ),
        ),
      );
