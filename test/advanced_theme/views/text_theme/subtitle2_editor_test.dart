...
void main() {
  ...
  Future<void> _pumpApp(WidgetTester tester, AdvancedThemeState state) async {
    ...
    await tester.pumpApp(Subtitle2Editor(), advancedThemeCubit: cubit);
  }
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final state = AdvancedThemeState(
        themeData: ThemeData(
          textTheme: TextTheme(
            subtitle2: TextStyle(fontSize: value),
          ),
        ),
      );
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final state = AdvancedThemeState(
        themeData: ThemeData(
          textTheme: TextTheme(
            subtitle2: TextStyle(letterSpacing: value),
          ),
        ),
      );
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final state = AdvancedThemeState(
        themeData: ThemeData(
          textTheme: TextTheme(
            subtitle2: TextStyle(wordSpacing: value),
          ),
        ),
      );
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final state = AdvancedThemeState(
        themeData: ThemeData(
          textTheme: TextTheme(
            subtitle2: TextStyle(height: value),
          ),
        ),
      );
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final state = AdvancedThemeState(
        themeData: ThemeData(
          textTheme: TextTheme(
            subtitle2: TextStyle(decorationThickness: value),
          ),
        ),
      );
