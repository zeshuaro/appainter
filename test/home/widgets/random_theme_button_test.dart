    ...
    await tester.pumpWidget(
      MultiBlocProvider(
        ...
        child: const MaterialApp(
          home: Scaffold(body: RandomThemeButton()),
        ),
      ),
    );
  }

  testWidgets('should randomize basic theme', (tester) async {
    ...
    verify(() => basicThemeCubit.themeRandomized()).called(1);
    verifyNever(() => advancedThemeCubit.themeRandomized());
  });

  testWidgets('should randomize advanced theme', (tester) async {
    when(() => homeCubit.state).thenReturn(
    ...
    verify(() => advancedThemeCubit.themeRandomized()).called(1);
    verifyNever(() => basicThemeCubit.themeRandomized());
  });
}
